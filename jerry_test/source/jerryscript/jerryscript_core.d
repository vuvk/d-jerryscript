 ...
 */
enum JERRY_API_MAJOR_VERSION = 1;

/**
 * Minor version of JerryScript API.
 */
enum JERRY_API_MINOR_VERSION = 0;

/**
 * JerryScript init flags.
 */
enum jerry_init_flag_t
{
...
enum jerry_error_t
{
    ...
    JERRY_ERROR_COMMON = 1, /**< Error */
    JERRY_ERROR_EVAL = 2, /**< EvalError */
    JERRY_ERROR_RANGE = 3, /**< RangeError */
    JERRY_ERROR_REFERENCE = 4, /**< ReferenceError */
    JERRY_ERROR_SYNTAX = 5, /**< SyntaxError */
    JERRY_ERROR_TYPE = 6, /**< TypeError */
    JERRY_ERROR_URI = 7 /**< URIError */
}
...
{
    JERRY_FEATURE_CPOINTER_32_BIT = 0, /**< 32 bit compressed pointers */
    JERRY_FEATURE_ERROR_MESSAGES = 1, /**< error messages */
    JERRY_FEATURE_JS_PARSER = 2, /**< js-parser */
    JERRY_FEATURE_MEM_STATS = 3, /**< memory statistics */
    JERRY_FEATURE_PARSER_DUMP = 4, /**< parser byte-code dumps */
    JERRY_FEATURE_REGEXP_DUMP = 5, /**< regexp byte-code dumps */
    JERRY_FEATURE_SNAPSHOT_SAVE = 6, /**< saving snapshot files */
    JERRY_FEATURE_SNAPSHOT_EXEC = 7, /**< executing snapshot files */
    JERRY_FEATURE_DEBUGGER = 8, /**< debugging */
    JERRY_FEATURE_VM_EXEC_STOP = 9, /**< stopping ECMAScript execution */
    JERRY_FEATURE_JSON = 10, /**< JSON support */
    JERRY_FEATURE_PROMISE = 11, /**< promise support */
    JERRY_FEATURE_TYPEDARRAY = 12, /**< Typedarray support */
    JERRY_FEATURE_DATE = 13, /**< Date support */
    JERRY_FEATURE_REGEXP = 14, /**< Regexp support */
    JERRY_FEATURE_LINE_INFO = 15, /**< line info available */
    JERRY_FEATURE__COUNT = 16 /**< number of features. NOTE: must be at the end of the list */
}

/**
 * Option flags for jerry_parse and jerry_parse_function functions.
 */
enum jerry_parse_opts_t
{
 ...
 */
alias jerry_char_t = ubyte;

/**
 * Pointer to an array of character values.
 */
alias jerry_char_ptr_t = ubyte*;

/**
 * Size type of JerryScript.
 */
alias jerry_size_t = uint;

/**
 * Length type of JerryScript.
 */
alias jerry_length_t = uint;

/**
 * Description of a JerryScript value.
 */
alias jerry_value_t = uint;
...
{
    /** Is [[Value]] defined? */
    ubyte is_value_defined;

    /** Is [[Get]] defined? */
    ubyte is_get_defined;

    /** Is [[Set]] defined? */
    ubyte is_set_defined;

    /** Is [[Writable]] defined? */
    ubyte is_writable_defined;

    /** [[Writable]] */
    ubyte is_writable;

    /** Is [[Enumerable]] defined? */
    ubyte is_enumerable_defined;

    /** [[Enumerable]] */
    ubyte is_enumerable;

    /** Is [[Configurable]] defined? */
    ubyte is_configurable_defined;

    /** [[Configurable]] */
    ubyte is_configurable;
 ...
 */
struct jerry_heap_stats_t
{
    size_t version_; /**< the version of the stats struct */
    size_t size; /**< heap total size */
    size_t allocated_bytes; /**< currently allocated bytes */
    size_t peak_allocated_bytes; /**< peak allocated bytes */
    size_t[4] reserved; /**< padding for future extensions */
}

/**
 * Type of an external function handler.
 */
alias jerry_external_handler_t = uint function (
 ...
 */
alias jerry_object_free_callback_t = void function (const uintptr_t native_p);

/**
 * Native free callback of an object.
 */
alias jerry_object_native_free_callback_t = void function (void* native_p);
 ...
 */
alias jerry_vm_exec_stop_callback_t = uint function (void* user_p);

/**
 * Function type applied for each data property of an object.
 */
alias jerry_object_property_foreach_t = ubyte function (
 ...
 */
alias jerry_objects_foreach_t = ubyte function (
 ...
 */
alias jerry_objects_foreach_by_native_info_t = ubyte function (
    const jerry_value_t object,
    void* object_data_p,
    void* user_data_p);
 ...
 */
struct jerry_context_data_manager_t
{
    /**
     ...
     */
    void function (void* data) init_cb;
     ...
     */
    void function (void* data) deinit_cb;
     ...
     */
    void function (void* data) finalize_cb;
 ...
 */
alias jerry_instance_alloc_t = void* function (size_t size, void* cb_data_p);
...
void jerry_cleanup ();
void jerry_register_magic_strings (
    const(jerry_char_ptr_t)* ex_str_items_p,
    uint count,
    const(jerry_length_t)* str_lengths_p);
void jerry_gc ();
void* jerry_get_context_data (const(jerry_context_data_manager_t)* manager_p);

ubyte jerry_get_memory_stats (jerry_heap_stats_t* out_stats_p);

/**
 * Parser and executor functions.
 */
ubyte jerry_run_simple (const(jerry_char_t)* script_source_p, size_t script_source_size, jerry_init_flag_t flags);
jerry_value_t jerry_parse (
    const(jerry_char_t)* resource_name_p,
    size_t resource_name_length,
    const(jerry_char_t)* source_p,
    size_t source_size,
    uint parse_opts);
jerry_value_t jerry_parse_function (
    const(jerry_char_t)* resource_name_p,
    size_t resource_name_length,
    const(jerry_char_t)* arg_list_p,
    size_t arg_list_size,
    const(jerry_char_t)* source_p,
    size_t source_size,
    uint parse_opts);
jerry_value_t jerry_run (const jerry_value_t func_val);
jerry_value_t jerry_eval (const(jerry_char_t)* source_p, size_t source_size, ubyte is_strict);

jerry_value_t jerry_run_all_enqueued_jobs ();
 ...
 */
ubyte jerry_value_is_abort (const jerry_value_t value);
ubyte jerry_value_is_array (const jerry_value_t value);
ubyte jerry_value_is_boolean (const jerry_value_t value);
ubyte jerry_value_is_constructor (const jerry_value_t value);
ubyte jerry_value_is_error (const jerry_value_t value);
ubyte jerry_value_is_function (const jerry_value_t value);
ubyte jerry_value_is_number (const jerry_value_t value);
ubyte jerry_value_is_null (const jerry_value_t value);
ubyte jerry_value_is_object (const jerry_value_t value);
ubyte jerry_value_is_promise (const jerry_value_t value);
ubyte jerry_value_is_string (const jerry_value_t value);
ubyte jerry_value_is_undefined (const jerry_value_t value);
...
enum jerry_type_t
{
    ...
    JERRY_TYPE_FUNCTION = 7 /**< function type */
}
 ...
 */
ubyte jerry_is_feature_enabled (const jerry_feature_t feature);

/**
 * Error manipulation functions.
 */
jerry_value_t jerry_get_value_from_error (jerry_value_t value, int release);
 ...
 */
ubyte jerry_get_boolean_value (const jerry_value_t value);
...
jerry_size_t jerry_string_to_utf8_char_buffer (
    const jerry_value_t value,
    jerry_char_t* buffer_p,
    jerry_size_t buffer_size);
jerry_size_t jerry_substring_to_char_buffer (
    const jerry_value_t value,
    jerry_length_t start_pos,
    jerry_length_t end_pos,
    jerry_char_t* buffer_p,
    jerry_size_t buffer_size);
jerry_size_t jerry_substring_to_utf8_char_buffer (
    const jerry_value_t value,
    jerry_length_t start_pos,
    jerry_length_t end_pos,
    jerry_char_t* buffer_p,
 ...
 */
uint jerry_get_array_length (const jerry_value_t value);
...
jerry_value_t jerry_create_number_infinity (ubyte sign);
jerry_value_t jerry_create_number_nan ();
jerry_value_t jerry_create_null ();
jerry_value_t jerry_create_object ();
jerry_value_t jerry_create_promise ();
...
ubyte jerry_delete_property (const jerry_value_t obj_val, const jerry_value_t prop_name_val);
ubyte jerry_delete_property_by_index (const jerry_value_t obj_val, uint index);

jerry_value_t jerry_get_property (const jerry_value_t obj_val, const jerry_value_t prop_name_val);
jerry_value_t jerry_get_property_by_index (const jerry_value_t obj_val, uint index);
jerry_value_t jerry_set_property (
    const jerry_value_t obj_val,
    const jerry_value_t prop_name_val,
    const jerry_value_t value_to_set);
jerry_value_t jerry_set_property_by_index (
    const jerry_value_t obj_val,
    uint index,
    const jerry_value_t value_to_set);

void jerry_init_property_descriptor_fields (jerry_property_descriptor_t* prop_desc_p);
jerry_value_t jerry_define_own_property (
    const jerry_value_t obj_val,
    const jerry_value_t prop_name_val,
    const(jerry_property_descriptor_t)* prop_desc_p);

ubyte jerry_get_own_property_descriptor (
    const jerry_value_t obj_val,
    const jerry_value_t prop_name_val,
...
jerry_value_t jerry_call_function (
    const jerry_value_t func_obj_val,
    const jerry_value_t this_val,
    const(jerry_value_t)* args_p,
    jerry_size_t args_count);
jerry_value_t jerry_construct_object (
    const jerry_value_t func_obj_val,
    const(jerry_value_t)* args_p,
    jerry_size_t args_count);
...
ubyte jerry_get_object_native_handle (
    const jerry_value_t obj_val,
...
ubyte jerry_get_object_native_pointer (
    const jerry_value_t obj_val,
    void** out_native_pointer_p,
    const(jerry_object_native_info_t*)* out_pointer_info_p);
ubyte jerry_objects_foreach (jerry_objects_foreach_t foreach_p, void* user_data);
ubyte jerry_objects_foreach_by_native_info (
    const(jerry_object_native_info_t)* native_info_p,
    jerry_objects_foreach_by_native_info_t foreach_p,
    void* user_data_p);
void jerry_set_object_native_pointer (
    const jerry_value_t obj_val,
    void* native_pointer_p,
    const(jerry_object_native_info_t)* native_info_p);

ubyte jerry_foreach_object_property (
    const jerry_value_t obj_val,
 ...
 */
jerry_value_t jerry_resolve_or_reject_promise (jerry_value_t promise, jerry_value_t argument, ubyte is_resolve);

/**
 * Input validator functions.
 */
ubyte jerry_is_valid_utf8_string (const(jerry_char_t)* utf8_buf_p, jerry_size_t buf_size);
ubyte jerry_is_valid_cesu8_string (const(jerry_char_t)* cesu8_buf_p, jerry_size_t buf_size);

/*
 * External context functions.
 */
jerry_instance_t* jerry_create_instance (uint heap_size, jerry_instance_alloc_t alloc, void* cb_data_p);

/**
 * Miscellaneous functions.
 */
void jerry_set_vm_exec_stop_callback (jerry_vm_exec_stop_callback_t stop_cb, void* user_p, uint frequency);
jerry_value_t jerry_get_backtrace (uint max_depth);

/**
 * Array buffer components.
 */
ubyte jerry_value_is_arraybuffer (const jerry_value_t value);
...
jerry_length_t jerry_arraybuffer_read (
    const jerry_value_t value,
    jerry_length_t offset,
    ubyte* buf_p,
    jerry_length_t buf_size);
jerry_length_t jerry_get_arraybuffer_byte_length (const jerry_value_t value);
ubyte* jerry_get_arraybuffer_pointer (const jerry_value_t value);
 ...
 * TypedArray types.
 */
enum jerry_typedarray_type_t
{
    JERRY_TYPEDARRAY_INVALID = 0,
    JERRY_TYPEDARRAY_UINT8 = 1,
    JERRY_TYPEDARRAY_UINT8CLAMPED = 2,
    JERRY_TYPEDARRAY_INT8 = 3,
    JERRY_TYPEDARRAY_UINT16 = 4,
    JERRY_TYPEDARRAY_INT16 = 5,
    JERRY_TYPEDARRAY_UINT32 = 6,
    JERRY_TYPEDARRAY_INT32 = 7,
    JERRY_TYPEDARRAY_FLOAT32 = 8,
    JERRY_TYPEDARRAY_FLOAT64 = 9
}

ubyte jerry_value_is_typedarray (jerry_value_t value);
jerry_value_t jerry_create_typedarray (jerry_typedarray_type_t type_name, jerry_length_t length);
jerry_value_t jerry_create_typedarray_for_arraybuffer_sz (
...
jerry_value_t jerry_get_typedarray_buffer (
    jerry_value_t value,
    jerry_length_t* byte_offset,
